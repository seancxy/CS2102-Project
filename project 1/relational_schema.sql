...
CREATE TABLE Creators (
  ...
  tax_code       TEXT NOT NULL, -- derived attribute (may need to remove)
...
CREATE TABLE Refund(
      ...
      pid SERIAL,
      PRIMARY KEY (backer_email, level_name, pid),
      FOREIGN KEY (backer_email, pid) REFERENCES Backs(backer_email, pid) ON DELETE CASCADE ON UPDATE CASCADE
);


CREATE TABLE Employees (
  employee_id SERIAL PRIMARY KEY,-- Each project must have a creator
  name        TEXT NOT NULL,
  salary      NUMERIC NOT NULL
);


-- does not capture each refund processed once
