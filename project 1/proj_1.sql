...
-- includes Tiers relationship
CREATE TABLE RewardLevels (
name        TEXT,
project_id        SERIAL,
min_funding 	   NUMERIC NOT NULL,
FOREIGN KEY (project_id) REFERENCES Projects(project_id) ON DELETE CASCADE ON UPDATE CASCADE, -- Weak entity
...
level_name, pid) ON DELETE CASCADE ON UPDATE CASCADE -- Weak entity
);
...
email     TEXT,
employee_id	 SERIAL,
date       DATE NOT NULL, -- Verification Date
