/** Setting up the schema and trigger 5 for testing **/
...
DROP TRIGGER IF EXISTS create_back ON Backs;
DROP FUNCTION IF EXISTS back_date_check();
...
('backer1@gmail.com', 'bronze', 1, '2021-10-01', null, 200),
('backer1@gmail.com', 'silver', 2, '2022-10-01', null, 400),
('backer1@gmail.com', 'gold', 3, '2021-10-02', null, 600);

/** Invalid backings, exception should be raised **/
/** Before created **/
INSERT INTO Backs VALUES
('backer3@gmail.com', 'gold', 4, '2021-09-30', null, 600);

INSERT INTO Backs VALUES
('backer3@gmail.com', 'gold', 4, '2022-10-02', null, 600);
